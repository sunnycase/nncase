...
public sealed class QKVParallelLinearEvaluator : ITypeInferencer<QKVParallelLinear>, IKernelInfoEvaluator<QKVParallelLinear>
{
    public IRType Visit(ITypeInferenceContext context, QKVParallelLinear target) => TupleType.Void;

    public MicroKernelInfo Visit(QKVParallelLinear op, MicroKernelContext context)
    {
