...
public sealed class WhereEvaluator : ITypeInferencer<Where>, ITileWorkloadEvaluator<Where>
{
    public IRType Visit(ITypeInferenceContext context, Where target) => TupleType.Void;

    public TileWorkload Visit(Where op, TileWorkloadContext context) => new ElementwiseTileWorkload(GetComputeWork);
