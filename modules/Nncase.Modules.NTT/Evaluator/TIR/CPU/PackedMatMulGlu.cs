...
public sealed class PackedMatMulGluEvaluator : ITypeInferencer<PackedMatMulGlu>, IKernelInfoEvaluator<PackedMatMulGlu>
{
    public IRType Visit(ITypeInferenceContext context, PackedMatMulGlu target) => TupleType.Void;

    public MicroKernelInfo Visit(PackedMatMulGlu op, MicroKernelContext context)
    {
