...
public sealed class PackedMatMulNormStatsEvaluator :
    ...
    ITileWorkloadEvaluator<PackedMatMulNormStats>
{
    public IRType Visit(ITypeInferenceContext context, PackedMatMulNormStats target) => TupleType.Void;

    public TileWorkload Visit(PackedMatMulNormStats op, TileWorkloadContext context) =>
