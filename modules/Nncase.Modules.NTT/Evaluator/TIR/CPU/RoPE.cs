...
public sealed class RoPEEvaluator : ITypeInferencer<RoPE>, ITileWorkloadEvaluator<RoPE>
{
    public IRType Visit(ITypeInferenceContext context, RoPE target) => TupleType.Void;

    public TileWorkload Visit(RoPE rope, TileWorkloadContext context) => new ElementwiseTileWorkload(GetComputeWork);
