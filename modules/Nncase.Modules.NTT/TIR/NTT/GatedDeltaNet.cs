...
{
    public static readonly ParameterInfo QKV = new(typeof(GatedDeltaNetConvolution), 0, "qkv", memoryEffect: MemoryEffect.Read.AcrossPartialOwners());
...
public sealed partial class GatedDeltaNetRecurrentCore : NTTKernelOp
{
    ...
    public static readonly ParameterInfo Z = new(typeof(GatedDeltaNetRecurrentCore), 2, "z", memoryEffect: MemoryEffect.Read.AcrossPartialOwners());
