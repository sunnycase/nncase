...
enum sampler_logprobs_mode : uint8_t {
    raw_logprobs = 0,
    raw_logits = 1,
...
typedef struct {
    ...
    void (*huggingface_options_enable_sampler)(
        clr_object_handle_t huggingface_options, bool enable_sampler);
    bool (*huggingface_options_get_enable_sampler)(
        clr_object_handle_t huggingface_options);
    void (*huggingface_options_sampler_max_batch_size)(
        clr_object_handle_t huggingface_options, int32_t max_batch_size);
    int32_t (*huggingface_options_get_sampler_max_batch_size)(
        clr_object_handle_t huggingface_options);
    void (*huggingface_options_sampler_max_logprobs)(
        clr_object_handle_t huggingface_options, int32_t max_logprobs);
    int32_t (*huggingface_options_get_sampler_max_logprobs)(
        clr_object_handle_t huggingface_options);
    void (*huggingface_options_sampler_logprobs_mode)(
        clr_object_handle_t huggingface_options, uint8_t logprobs_mode);
    uint8_t (*huggingface_options_get_sampler_logprobs_mode)(
        clr_object_handle_t huggingface_options);
    ...
    void (*shape_bucket_options_set_segment_ranges)(
        clr_object_handle_t shape_bucket_options, const char *segment_ranges,
        size_t segment_ranges_size);
    ...
    void (*cpu_target_options_set_vectorize)(clr_object_handle_t handle, uint8_t value);
...
class shape_bucket_options : public clr_object_base {
  public:
    ...
    std::map<std::string, std::vector<int>> segment_ranges() { return {}; }
    NNCASE_API void segment_ranges(std::map<std::string, std::vector<int>> value);
};
...
class huggingface_options : public clr_object_base {
  public:
    ...
    bool enable_sampler() {
        return nncase_clr_api()->huggingface_options_get_enable_sampler(
            obj_.get());
    }
    void enable_sampler(bool value) {
        nncase_clr_api()->huggingface_options_enable_sampler(obj_.get(), value);
    }

    int32_t sampler_max_batch_size() {
        return nncase_clr_api()->huggingface_options_get_sampler_max_batch_size(
            obj_.get());
    }
    void sampler_max_batch_size(int32_t value) {
        if (value <= 0) {
            throw std::invalid_argument(
                "sampler_max_batch_size must be positive");
        }
        nncase_clr_api()->huggingface_options_sampler_max_batch_size(obj_.get(),
                                                                     value);
    }

    int32_t sampler_max_logprobs() {
        return nncase_clr_api()->huggingface_options_get_sampler_max_logprobs(
            obj_.get());
    }
    void sampler_max_logprobs(int32_t value) {
        if (value < 0) {
            throw std::invalid_argument(
                "sampler_max_logprobs must be non-negative");
        }
        nncase_clr_api()->huggingface_options_sampler_max_logprobs(obj_.get(),
                                                                   value);
    }

    sampler_logprobs_mode sampler_logprobs_mode_value() {
        return static_cast<sampler_logprobs_mode>(
            nncase_clr_api()->huggingface_options_get_sampler_logprobs_mode(
                obj_.get()));
    }
    void sampler_logprobs_mode_value(sampler_logprobs_mode value) {
        if (value < raw_logprobs || value > processed_logits) {
            throw std::invalid_argument(
                "sampler_logprobs_mode has an unsupported value");
        }
        nncase_clr_api()->huggingface_options_sampler_logprobs_mode(
            obj_.get(), static_cast<uint8_t>(value));
    }
...
class cpu_target_options : public clr_object_base {
  public:
    ...
    void vectorize(bool value) {
        nncase_clr_api()->cpu_target_options_set_vectorize(obj_.get(), value);
    }
...
class pyntt_target_options : public cpu_target_options {
  public:
    using cpu_target_options::cpu_target_options;

    pyntt_target_options() {
        obj_ = nncase_clr_api()->pyntt_target_options_create();
    }
