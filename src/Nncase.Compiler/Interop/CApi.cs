...
public unsafe struct CApiMT
{
    ...
    public delegate* unmanaged<IntPtr, byte*, nuint, void> ShapeBucketOptionsSetSegmentRangesPtr;
    /* This block is generated by tools/stackvm_gen/CApiGen at 12/20/2024 5:31:31 PM +08:00. */
    public delegate* unmanaged<IntPtr> CPUTargetOptionsCreatePtr;
    public delegate* unmanaged<IntPtr, byte*, nuint, void> CPUTargetOptionsSetModelNamePtr;
    public delegate* unmanaged<IntPtr, byte, void> CPUTargetOptionsSetVectorizePtr;
    public delegate* unmanaged<IntPtr, byte, void> CPUTargetOptionsSetUnifiedMemoryArchPtr;
    public delegate* unmanaged<IntPtr, MemoryAccessArchitecture> CPUTargetOptionsGetMemoryAccessArchPtr;
    public delegate* unmanaged<IntPtr, MemoryAccessArchitecture, void> CPUTargetOptionsSetMemoryAccessArchPtr;
    public delegate* unmanaged<IntPtr, NocArchitecture> CPUTargetOptionsGetNocArchPtr;
    public delegate* unmanaged<IntPtr, NocArchitecture, void> CPUTargetOptionsSetNocArchPtr;
    ...
    public delegate* unmanaged<IntPtr, byte*, nuint, void> CPUTargetOptionsSetHierarchyLevelsPtr;
...
public static unsafe class CApi
{
    ...
    public static void Initialize(CApiMT* mt)
    {
        ...
        mt->CompileOptionsSetCPUTargetOptionsPtr = &CompileOptionsSetNTTTargetOptions;
        ...
        mt->ShapeBucketOptionsSetSegmentRangesPtr = &ShapeBucketOptionsSetSegmentRanges;
        /* This block is generated by tools/stackvm_gen/CApiGen at 12/20/2024 3:41:05 PM +08:00. */
        mt->CPUTargetOptionsCreatePtr = &NTTTargetOptionsCreate;
        mt->CPUTargetOptionsSetModelNamePtr = &NTTTargetOptionsSetModelName;
        mt->CPUTargetOptionsSetVectorizePtr = &NTTTargetOptionsSetVectorize;
        mt->CPUTargetOptionsSetUnifiedMemoryArchPtr = &NTTTargetOptionsSetUnifiedMemoryArch;
        mt->CPUTargetOptionsGetMemoryAccessArchPtr = &NTTTargetOptionsGetMemoryAccessArch;
        mt->CPUTargetOptionsSetMemoryAccessArchPtr = &NTTTargetOptionsSetMemoryAccessArch;
        mt->CPUTargetOptionsGetNocArchPtr = &NTTTargetOptionsGetNocArch;
        mt->CPUTargetOptionsSetNocArchPtr = &NTTTargetOptionsSetNocArch;
        mt->CPUTargetOptionsSetHierarchiesPtr = &NTTTargetOptionsSetHierarchies;
        mt->CPUTargetOptionsSetHierarchyNamesPtr = &NTTTargetOptionsSetHierarchyNames;
        mt->CPUTargetOptionsSetHierarchyLevelsPtr = &NTTTargetOptionsSetHierarchyLevels;
    ...
    [UnmanagedCallersOnly]
    private static void HuggingFaceOptionsInputIdsType(IntPtr huggingFaceOptionsHandle, byte* inputIdsTypePtr, nuint inputIdsTypeLength)
    {
        var inputIdsType = ToString(inputIdsTypePtr, inputIdsTypeLength);
        Get<HuggingFaceOptions>(huggingFaceOptionsHandle).InputIdsType = inputIdsType;
    }
    ...
    [UnmanagedCallersOnly]
    private static void CompileOptionsSetNTTTargetOptions(IntPtr compileOptionsHandle, IntPtr targetOptionsHandle)
    {
        Get<CompileOptions>(compileOptionsHandle).TargetOptions = Get<Targets.NTTTargetOptions>(targetOptionsHandle);
    }
    ...
    [UnmanagedCallersOnly]
    private static void ShapeBucketOptionsSetSegmentRanges(IntPtr shapeBucketOptionsHandle, byte* segmentRanges, nuint segmentRangesSize)
    {
        byte[] segmentRangesByte = new byte[segmentRangesSize];
        Marshal.Copy(new IntPtr(segmentRanges), segmentRangesByte, 0, (int)segmentRangesSize);
        string jsonStr = Encoding.UTF8.GetString(segmentRangesByte);
        Dictionary<string, int[]> segmentRangesStruct = JsonConvert.DeserializeObject<Dictionary<string, int[]>>(jsonStr)!;
        Get<ShapeBucketOptions>(shapeBucketOptionsHandle).SegmentRanges = segmentRangesStruct;
    }

    /* This block is generated by tools/stackvm_gen/CApiGen at 12/20/2024 5:31:31 PM +08:00. */
    [UnmanagedCallersOnly]
    private static IntPtr NTTTargetOptionsCreate()
    {
        return GCHandle.ToIntPtr(GCHandle.Alloc(new NTTTargetOptions()));
    }

    [UnmanagedCallersOnly]
    private static void NTTTargetOptionsSetModelName(IntPtr handle, byte* value, nuint length)
    {
        Get<NTTTargetOptions>(handle).ModelName = ToString(value, length);
    }

    [UnmanagedCallersOnly]
    private static void NTTTargetOptionsSetVectorize(IntPtr handle, byte value)
    {
        Get<NTTTargetOptions>(handle).Vectorize = value != 0;
    }

    [UnmanagedCallersOnly]
    private static void NTTTargetOptionsSetUnifiedMemoryArch(IntPtr handle, byte value)
    {
        Get<NTTTargetOptions>(handle).UnifiedMemoryArch = value != 0;
    }

    [UnmanagedCallersOnly]
    private static MemoryAccessArchitecture NTTTargetOptionsGetMemoryAccessArch(IntPtr handle)
    {
        return Get<NTTTargetOptions>(handle).MemoryAccessArch;
    }

    [UnmanagedCallersOnly]
    private static void NTTTargetOptionsSetMemoryAccessArch(IntPtr handle, MemoryAccessArchitecture value)
    {
        Get<NTTTargetOptions>(handle).MemoryAccessArch = value;
    }

    [UnmanagedCallersOnly]
    private static NocArchitecture NTTTargetOptionsGetNocArch(IntPtr handle)
    {
        return Get<NTTTargetOptions>(handle).NocArch;
    }

    [UnmanagedCallersOnly]
    private static void NTTTargetOptionsSetNocArch(IntPtr handle, NocArchitecture value)
    {
        Get<NTTTargetOptions>(handle).NocArch = value;
    }
    ...
    [UnmanagedCallersOnly]
    private static void NTTTargetOptionsSetHierarchySizes(IntPtr handle, long* value, nuint shape0)
    {
        Get<NTTTargetOptions>(handle).HierarchySizes = To1DArray(value, shape0);
    }

    [UnmanagedCallersOnly]
    private static void NTTTargetOptionsSetHierarchyLatencies(IntPtr handle, int* value, nuint shape0)
    {
        Get<NTTTargetOptions>(handle).HierarchyLatencies = To1DArray(value, shape0);
    }

    [UnmanagedCallersOnly]
    private static void NTTTargetOptionsSetHierarchyBandWidths(IntPtr handle, int* value, nuint shape0)
    {
        Get<NTTTargetOptions>(handle).HierarchyBandWidths = To1DArray(value, shape0);
    }
    ...
    [UnmanagedCallersOnly]
    private static void NTTTargetOptionsSetDistributedScheme(IntPtr handle, byte* value, nuint length)
    {
        Get<NTTTargetOptions>(handle).DistributedScheme = ToString(value, length);
    }
    ...
    [UnmanagedCallersOnly]
    private static IntPtr PyNTTTargetOptionsCreate()
    {
        return GCHandle.ToIntPtr(GCHandle.Alloc(new PyNTTTargetOptions()));
    }
