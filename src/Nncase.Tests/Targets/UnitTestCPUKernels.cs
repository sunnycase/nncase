...
public sealed class TestUpdatePagedAttentionCaseData : TheoryData<TestFixture.PagedAttentionKVCacheTestFixture, int[], int>
{
    ...
    [
        (new[] { PagedKVCacheDimKind.NumBlocks }, new[] { SBP.SContiguous([0]) }, [1]),
    ];
