...
public sealed class Function : BaseFunction
{
    ...
    public Function(string name, BaseExpr body, ReadOnlySpan<IVar> parameters)
        : this(name, body, parameters, new Dictionary<IVar, Dimension[]>())
    {
    }

    public Function(string name, string moduleKind, BaseExpr body, ReadOnlySpan<IVar> parameters, Dictionary<IVar, Dimension[]>? varMap = null)
    ...
    public Function(string name, BaseExpr body, ReadOnlySpan<IVar> parameters, Dictionary<IVar, Dimension[]>? varMap)
    ...
    public Function(BaseExpr body, ReadOnlySpan<IVar> parameters)
        : this($"func_{_globalFuncIndex++}", body, parameters, new Dictionary<IVar, Dimension[]>())
    {
    }
