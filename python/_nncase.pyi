...
class SamplerLogprobsMode:
    __members__: ClassVar[dict] = ...  # read-only
    RawLogprobs: ClassVar[SamplerLogprobsMode] = ...
    RawLogits: ClassVar[SamplerLogprobsMode] = ...
    ProcessedLogprobs: ClassVar[SamplerLogprobsMode] = ...
    ProcessedLogits: ClassVar[SamplerLogprobsMode] = ...
    def __init__(self, value: int) -> None: ...
    def __int__(self) -> int: ...
    @property
    def name(self) -> str: ...
...
class HuggingFaceOptions:
    ...
    enable_sampler: bool
    sampler_max_batch_size: int
    sampler_max_logprobs: int
    sampler_logprobs_mode: SamplerLogprobsMode
    num_layers: int
    tensor_type: str
    input_ids_type: str
    def __init__(self) -> None: ...
